/* soneralbayrak.com/schedule — main.js
   (The teaching site's script; the one change is that the running head's
   default text is read from the page instead of being written in here.)
...
(function () {
  ...
  var markDefault = mark ? mark.textContent : "";   /* shown above the first section */
  ...
  function update() {
    ...
    if (mark) mark.textContent = cur ? cur.label : markDefault;
